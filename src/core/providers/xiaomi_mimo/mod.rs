    ...
    fn build_headers(&self) -> Result<HeaderMap, XiaomiMIMOError> {
        ...
        if let Some(api_key) = &self.config.api_key {
            let auth_value = HeaderValue::from_str(&format!("Bearer {}", api_key))
                .map_err(|e| ProviderError::configuration("xiaomi_mimo", format!("Invalid API key: {}", e)))?;
...
impl LLMProvider for XiaomiMIMOProvider {
    ...
    async fn transform_response(
        ...
        Err(ProviderError::not_implemented("xiaomi_mimo", "Response transformation not yet implemented"))
    }
    ...
    async fn chat_completion(
        ...
        Err(ProviderError::not_implemented("xiaomi_mimo", "Chat completion not yet implemented"))
    }
    ...
    {
        Err(ProviderError::not_implemented("xiaomi_mimo", "Streaming not yet implemented"))
    }
    ...
    async fn image_generation(
        ...
        Err(ProviderError::not_supported("xiaomi_mimo", "Image generation"))
    }
}
