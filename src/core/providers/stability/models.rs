    ...
    pub fn new() -> Self {
        let models = vec![
            ModelInfo {
                ...
                description: Some("Stability AI's Stable Diffusion 3 model".to_string()),
                context_length: 0,
                max_output_tokens: 0,
                supported_features: vec!["image_generation".to_string()],
                pricing: None,
            },
            ModelInfo {
                id: "stability/sd3-turbo".to_string(),
                name: "Stable Diffusion 3 Turbo".to_string(),
                description: Some("Fast variant of Stable Diffusion 3".to_string()),
                context_length: 0,
                max_output_tokens: 0,
                supported_features: vec!["image_generation".to_string()],
                pricing: None,
            ...
            ModelInfo {
                ...
                description: Some("Stability AI's Stable Diffusion 3.5 Large model".to_string()),
                context_length: 0,
                max_output_tokens: 0,
                supported_features: vec!["image_generation".to_string()],
                pricing: None,
            ...
            ModelInfo {
                ...
                description: Some("Fast variant of Stable Diffusion 3.5 Large".to_string()),
                context_length: 0,
                max_output_tokens: 0,
                supported_features: vec!["image_generation".to_string()],
                pricing: None,
            ...
            ModelInfo {
                ...
                description: Some("Medium-sized Stable Diffusion 3.5 model".to_string()),
                context_length: 0,
                max_output_tokens: 0,
                supported_features: vec!["image_generation".to_string()],
                pricing: None,
            ...
            ModelInfo {
                ...
                description: Some("Stability AI's highest quality image generation model".to_string()),
                context_length: 0,
                max_output_tokens: 0,
                supported_features: vec!["image_generation".to_string()],
                pricing: None,
            ...
            ModelInfo {
                ...
                description: Some("Stability AI's core image generation model".to_string()),
                context_length: 0,
                max_output_tokens: 0,
                supported_features: vec!["image_generation".to_string()],
                pricing: None,
