...
mod provider_error_tests {
    ...
    #[test]
    fn test_cancelled() {
        let err = ProviderError::cancelled("openai", "chat_completion", Some("User cancelled".to_string()));
        assert_eq!(err.provider(), "openai");
    ...
    fn test_error_type_strings() {
        ...
        assert_eq!(ProviderError::authentication("a", "b").error_type(), "authentication");
        assert_eq!(ProviderError::rate_limit("a", None).error_type(), "rate_limit");
        assert_eq!(ProviderError::quota_exceeded("a", "b").error_type(), "quota_exceeded");
        assert_eq!(ProviderError::model_not_found("a", "b").error_type(), "model_not_found");
